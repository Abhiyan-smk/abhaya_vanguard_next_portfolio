...
import { Building2, DraftingCompass, Map, Waves, Mountain, Hammer, FileText, Linkedin, ExternalLink } from "lucide-react";
...
export const actions = [
  { label: "Contact", href: "#contact", icon: ExternalLink },
